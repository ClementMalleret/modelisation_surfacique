...
class Patch:
    ...
    def draw_to(self, ax, Nx=20, Ny=20, **kwargs):
        """
        Draws the current patch to the given axes.
        Nx and Ny are the number of points to be calculated on each axis.
    ...
    def compute_isophote(self, L, c, epsilon, x_param, y_param):
        ...
        for the given brightness c, on the product of the given coordinate arrays, x_param
        and y_param.
        """
    ...
    def draw_isophote_to(self, ax, color, L, c, epsilon, x_param, y_param):
        ...
        Color is the color in which the isophote is drawn.
        L, c, epsilon, x_param and y_param are the parameters of the isophote. Please refer
        to the 'compute_isophote' documentation for more details.
        """
    ...
    def evaluate_principal_curvature(self, u, w):
        """
        Returns an np.array containing the 2 principal curvatures at the given parameters.
        """
    ...
    def evaluate_abs_curvature(self, Nx, Ny):
        """
        Evalutes the absolute curvature regularily, with Nx points along the x axis, and Ny along
        the y axis.
        """
